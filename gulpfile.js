...
_gulp2.default.task('babel_gulp', function () {
  return _gulp2.default.src('gulpfile.babel.js').pipe((0, _gulpBabel2.default)()).pipe($.rename("gulpfile.js")).pipe(_gulp2.default.dest('./'));
});
_gulp2.default.task('serve:my', function () {
  ...
  _gulp2.default.watch('app/fonts/**/*', ['fonts']);
  _gulp2.default.watch('bower.json', ['wiredep', 'fonts']);
  _gulp2.default.watch("gulpfile.babel.js", ["babel_gulp"]);
});
